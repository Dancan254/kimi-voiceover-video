...
The skill can find photos on [Wikimedia Commons](https://commons.wikimedia.org) and logos from
[Simple Icons](https://simpleicons.org). Those are **not** covered by this repository's licence:

- Each file carries its own licence, often requiring attribution. Keep a credit for every image and put
  it in your video description.
- Brand logos are trademarks of their owners. Check a brand's guidelines before using its mark.
